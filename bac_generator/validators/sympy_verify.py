...
def sympy_verify_exercise(exercise: dict) -> bool:
    ...
    try:
        if ex_id == "s1_ex1_prog_arith":
            ...
            a, b, c, val_rhs, x_sol = params["a"], params["b"], params["c"], params["val_rhs"], params["x"]
            ...
            n, k, m, p, val = params["n"], params["k"], params["m"], params["p"], params["val"]
            return int(math.comb(n, k) - math.perm(m, p)) == int(val)
